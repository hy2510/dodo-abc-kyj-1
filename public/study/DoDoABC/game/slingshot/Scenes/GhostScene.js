...
export default class GhostScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.quizData.map((data) => {
      this.load.image(
        data.Question,
        `https://wcfresource.a1edu.com/newsystem/image/dodoabc/phonics1/words/${data.Question}.png`
      );
    });
    ...
    // 플러그인
    const commonUrl =
      "https://raw.githubusercontent.com/rexrainbow/phaser3-rex-notes/master/dist/";
